...
class TechnicalIndicatorProvider:
    def __init__(self, time_series: pd.DataFrame, rounding_factor: int):
        ...
        self.sma_short_period: int = 9
        self.sma_middle_period: int = 12
        self.sma_long_period: int = 20
    ...
    def get_technical_indicators(self) -> pd.DataFrame:
        ...
        technical_indicators[self.column_names.sma_slope]: pd.Series = (self.sma_short.sma_indicator().diff() / self.sma_short_period).round(self.rounding_factor)
